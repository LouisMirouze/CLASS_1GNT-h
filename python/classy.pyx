    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            if name == 'h':
                ...
                value = self.th.YHe
            #elif name == 'bbn_alpha_sensitivity':
            #    value = self.th.bbn_alpha_sensitivity
            #elif name == 'has_varconst':
            #    value = self.th.has_varconst
            #elif name == 'index_bg_lambda_G':
                #value = pvecback[self.ba.index_bg_lambda_G]
            #elif name == 'index_bg_varc_alpha':
                #value = pvecback[self.ba.index_bg_varc_alpha]
            #elif name == 'index_bg_varc_me':
                #value = pvecback[self.ba.index_bg_varc_me]
            elif name == 'n_e':
                value = self.th.n_e
            elif name == 'A_s':
                value = self.pm.A_s
